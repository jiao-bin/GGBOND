    ...
    <div className="rounded-xl border border-slate-800 bg-slate-900/90 p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-100 flex items-center gap-2">
              生猪期现升贴水博弈标尺 (Basis & Arbitrage Gauge)
            </h3>
      ...
      <div className="mt-6 px-2">
        <div className="relative">
          ...
          >
            <div className={`px-2 py-0.5 rounded text-[11px] font-bold font-mono shadow-md ${
              isAlertOver20
          ...
          {/* 进度条轨道 */}
          <div className="h-3 rounded-full overflow-hidden flex shadow-inner bg-slate-800">
            {/* -20% ~ -10% 深度贴水 */}
          ...
          >
            <span className="absolute -bottom-5 -translate-x-1/2 text-[10px] font-mono text-rose-400 whitespace-nowrap font-semibold">
              +20% 警戒线
            </span>
          </div>
          {/* 0% 平水线 */}
          ...
          >
            <span className="absolute -bottom-5 -translate-x-1/2 text-[10px] font-mono text-slate-400 whitespace-nowrap">
              0% 平水
            </span>
          </div>
        </div>
        ...
        {/* 刻度文字 */}
        <div className="flex justify-between text-[10px] text-slate-400 mt-6 pt-1 font-mono">
          <span>-20% (现货挤仓)</span>
          <span>-10% (贴水)</span>
          <span>0%</span>
          <span>+10% (温和升水)</span>
